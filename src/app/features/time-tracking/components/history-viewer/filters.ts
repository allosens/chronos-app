    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      ...
      <div class="flex gap-2 mt-4">
        <button
          ...
          class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors"
        ...
        <button
          type="button"
          (click)="applyQuickFilter('lastWeek')"
          class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors"
          [attr.aria-label]="'Filter last week'"
        >
          Last Week
        </button>
        <button
        ...
        <button
          type="button"
          (click)="clearFilters()"
          class="px-4 py-2 text-sm font-medium text-red-700 bg-red-50 rounded-lg hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors ml-auto"
