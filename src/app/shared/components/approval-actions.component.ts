        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          <div class="flex gap-2 mt-3">
            <button
              ...
              class="flex-1 font-semibold py-2 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2"
              ...
              [class.disabled:bg-gray-300]="requireComments() && !commentControl.value?.trim()"
              [class.disabled:cursor-not-allowed]="requireComments() && !commentControl.value?.trim()"
              class="text-white"
